...
Agent: ✅ slot 8 "Before Frost Giant's Gate" · 🔑 a3f2c...
   📝 Recap: The party secured the frost giant map and chose the eastern pass.
   🧠 Memory: 1 permanent · 2 candidates
...
| 📋 **dnd-campaign-manager** | [SKILL.md](skills/dnd-campaign-manager/SKILL.md) | Campaign lifecycle, Snapshot recap, campaign memory, save/load, module import |
...
│   ├── dnd_save.py             #   Snapshot, delta recap, and campaign memory
