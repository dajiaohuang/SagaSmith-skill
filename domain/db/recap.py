...
from .models.runtime import CampaignSave
...
class RecapGenerator:
    ...
    async def generate(
        ...
        # Keep the domain package importable outside NanoBot. Prompt rendering
        # is a runtime adapter concern and is loaded only when generation runs.
